...
- **Quick Predict**: Instant predictions with detailed risk factor analysis
- **Risk Engine**: Rule-based risk scoring layered on top of ML predictions
- **Input Validation**: Sanity checks on numeric inputs before prediction
...
│   └── Predict.py            # Page 3: Quick predictions + risk analysis
├── dataset/
...
3. Go to **Page 3: Quick Predict**
4. Enter customer details and get instant prediction with risk analysis

### Option 2: Train on Your Own Data

1. Run `streamlit run app.py`
2. Go to **Page 1: Data Upload** and upload your CSV
3. Go to **Page 2: Model Training**
4. Select algorithm and click Train
...
- Input validation (total charges vs tenure sanity check)
- Loads pre-trained model from either training pipeline
- Shows churn probability and confidence scores
- Detailed risk factor analysis with color-coded risk levels
- Actionable recommendations per risk factor
...
5. [Imbalanced-learn (SMOTE)](https://imbalanced-learn.org/)
